...
public class KandyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Kandy Tour");
        actionBar.setDisplayShowHomeEnabled(true);
        actionBar.setDisplayHomeAsUpEnabled(true);

        databaseHelper = new DatabaseHelper(this);
        tourArrayList = databaseHelper.getAllTourData("Kandy");

        btnAddNewAnuTour = (Button) findViewById(R.id.btnAddNewAnuTour);
        lvTourView = (ListView) findViewById(R.id.lvTourView);

        tourListAdapter = new TourListAdapter(KandyActivity.this, tourArrayList);
        ...
        btnAddNewAnuTour.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(KandyActivity.this, AddTourActivity.class);
                intent.putExtra("tourType", "Kandy");
    ...
    private void goBack() {
        Intent intent = new Intent(KandyActivity.this, HomeActivity.class);
